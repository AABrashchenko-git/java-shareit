...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> editItem(Integer ownerId, Integer itemId, ItemDto itemDto) {
    ...
    public ResponseEntity<Object> addComment(Integer authorId, Integer itemId, CommentDto commentDto) {
