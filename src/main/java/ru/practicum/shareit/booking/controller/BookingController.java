...
public class BookingController {
    ...
    @GetMapping
    public List<BookingDto> getAllBookingsByBookerId(@RequestHeader("X-Sharer-User-Id") Integer bookerId,
    ...
    @GetMapping("/owner")
    public List<BookingDto> getAllBookingsByOwnerId(@RequestHeader("X-Sharer-User-Id") Integer ownerId,
